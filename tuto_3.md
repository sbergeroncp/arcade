...
Ajoute le bloc ``||Sprites:définir mySprite||`` (onglet Sprites) sous le bloc ``||scroller:déplacer avec les boutons||``.

Sélectionne ``||variables:mySprite2||`` et ``||Sprites:Food||``.
...
Glisse le bloc ``||Sprites:quand||`` (onglet Sprites) dans la zone de programmation.

Remplace la valeur ``||Sprites:Player||`` par la valeur ``||Sprites:Food||``.
...
Remplace la valeur ``||math:0||`` du bloc ``||math:choisir aléatoirement entre||`` de gauche par le bloc ``||scene:largeur de l'écran||``.

Remplace la valeur ``||math:0||`` du bloc ``||math:choisir aléatoirement entre||`` de droite par le bloc ``||scene:hauteur de l'écran||``.
